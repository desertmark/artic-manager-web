// UTIL CONSTANTS
// UTIL CONSTANTS
export const ARTICLES_FILTER_DELAY = 500;
...
export const LONG_POLLING_ARTICLE = 'LONG_POLLING_ARTICLE';
export const LONG_POLLING_ARTICLE_PENDING = 'LONG_POLLING_ARTICLE_PENDING';
export const LONG_POLLING_ARTICLE_FULFILLED = 'LONG_POLLING_ARTICLE_FULFILLED';
export const LONG_POLLING_ARTICLE_REJECTED = 'LONG_POLLING_ARTICLE_REJECTED';
export const LONG_POLLING_ARTICLE_STOP = 'LONG_POLLING_ARTICLE_STOP';
